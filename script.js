...
const data = [
  {
    ...
    project_description: 'I built this project with a team of four for the Final Capstone Project while at Microverse. It is based on an app to book an appointment with a doctor. This project uses two apps, one is a backend which is a rails APi and a React frontend.',
  ...
  },
  {
    ...
    counter_image: './images/Counter.svg',
    project_info_text: ['Front-End', '2021'],
    project_description: 'The Space Travelers\' Hub is a React app built with, components, hooks, state, redux, and run tests. It consists of Rockets, Missions, and the My Profile section.',
    tags: ['React', 'Redux', 'javascript'],
